...
class AppServerSvc(win32serviceutil.ServiceFramework):
    ...
    def main(self):
        ...
        if config:
            ...
            try:
                r = requests.get("https://assetmgmt.ashleycollinge.co.uk/{}".format(config_uri))
        ...
        while not registered:
            ...
            try:
                ...
                r = requests.post("https://assetmgmt.ashleycollinge.co.uk/agent/register", data=json.dumps(data), headers=headers)
